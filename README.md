...
Buka terminal di folder project, pastikan server database (MySQL/Laragon/XAMPP) sudah menyala, lalu jalankan:

```bash
# Jalankan server lokal Laravel dan compiler HMR secara bersamaan menggunakan bat file helper
run_dev.bat
```
