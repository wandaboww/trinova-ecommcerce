    ...
    <div x-data="{
        ...
        <div x-show="showAddModal"
            ...
            <div @click.away="showAddModal = false"
                 ...
                 class="w-full max-w-2xl bg-zinc-950 border border-zinc-900 rounded-3xl p-7 space-y-6 shadow-2xl">
                <div class="flex items-center justify-between border-b border-zinc-900 pb-4">
                    <h3 class="text-sm font-bold text-zinc-200 uppercase tracking-widest">+ Tambah Studi Kasus Baru</h3>
                ...
                <form action="{{ route('admin.portfolio.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Nama Klien / Brand</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Kategori Bisnis</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Masalah Awal Klien</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Hasil / ROI yang Dicapai</label>
                    ...
                    <div class="flex justify-end gap-3 pt-2 border-t border-zinc-900">
                        ...
                        <button type="submit" class="px-7 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs rounded-xl shadow-lg shadow-indigo-500/20 transition-all">Simpan Studi Kasus</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div x-show="showEditModal"
            ...
            <div @click.away="showEditModal = false"
                 ...
                 class="w-full max-w-2xl bg-zinc-950 border border-zinc-900 rounded-3xl p-7 space-y-6 shadow-2xl">
                <div class="flex items-center justify-between border-b border-zinc-900 pb-4">
                    <h3 class="text-sm font-bold text-zinc-200 uppercase tracking-widest">✏️ Edit Studi Kasus</h3>
