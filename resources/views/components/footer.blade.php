        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div class="lg:col-span-1">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-3 mb-4" aria-label="Trinova Digital">
                    <div class="w-9 h-9 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-xl flex items-center justify-center font-extrabold text-sm text-white">T</div>
                    <span class="font-extrabold text-lg tracking-tight text-zinc-100">Trinova<span class="text-indigo-400">Digital</span></span>
                </a>
                ...
                <div class="flex gap-3" aria-label="Media sosial Trinova Digital">
                    <a href="https://tiktok.com/@trinova.id" class="w-9 h-9 rounded-lg bg-zinc-800 border border-white/6 flex items-center justify-center text-zinc-500 hover:border-indigo-500 hover:text-indigo-400 transition-all duration-150" target="_blank" rel="noopener" aria-label="TikTok" id="footer-tiktok">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.86a8.27 8.27 0 004.84 1.55V7A4.85 4.85 0 0119.59 6.69z"/></svg>
                    </a>
                    <a href="https://instagram.com/trinova.id" class="w-9 h-9 rounded-lg bg-zinc-800 border border-white/6 flex items-center justify-center text-zinc-500 hover:border-indigo-500 hover:text-indigo-400 transition-all duration-150" target="_blank" rel="noopener" aria-label="Instagram" id="footer-instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="flex flex-col gap-3" role="list">
                    <li><a href="{{ route('program.show', 'start') }}"  class="text-sm text-zinc-500 hover:text-zinc-200 transition-colors" id="footer-program-start">Program START</a></li>
                    <li><a href="{{ route('program.show', 'grow') }}"   class="text-sm text-zinc-500 hover:text-zinc-200 transition-colors" id="footer-program-grow">Program GROW</a></li>
                    <li><a href="{{ route('program.show', 'scale') }}"  class="text-sm text-zinc-500 hover:text-zinc-200 transition-colors" id="footer-program-scale">Program SCALE</a></li>
                    <li><a href="{{ route('program.show', 'empire') }}" class="text-sm text-zinc-500 hover:text-zinc-200 transition-colors" id="footer-program-empire">Program EMPIRE</a></li>
                    @php
                ...
                <ul class="flex flex-col gap-3" role="list">
                    <li>
                        ...
                        <a href="https://wa.me/{{ $footerWaNum }}?text={{ urlencode($footerWaMsg) }}"
                           ...
                           target="_blank" rel="noopener" id="footer-wa-link">
                            💬 WhatsApp
                        </a>
                    </li>
                    <li>
                        <a href="mailto:halo@trinova.id" class="text-sm text-zinc-500 hover:text-zinc-200 transition-colors" id="footer-email-link">
                            ✉️ halo@trinova.id
                        </a>
                    </li>
                </ul>
